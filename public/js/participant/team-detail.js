$(document).ready(function() {
    ...
    $(document).on("click", "#btn-disband-team", function(e) {
        e.preventDefault();
        ...
        swal({
            "title" : "Disband \"" + team_name + "\"",
            "text" : "Do you really want to disband team?",
            "type" : "warning",
            "customClass" : "sweet-alert-custom",
            "showCancelButton" : true,
            "showConfirmButton" : true,
            ...
            $.ajax({
                "type" : "DELETE",
                "url" : api_url + "team/" + location.pathname.split("/")[2] + "/disband",
                "headers" : {
                    "Accept" : "application/json",
                    "Authorization" : "Bearer " + document.cookie.replace(/(?:(?:^|.*;\s*)participant_token\s*\=\s*([^;]*).*$)|^.*$/, "$1")
                }
