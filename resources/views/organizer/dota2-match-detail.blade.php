    ...
    <div id="wrapper">
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row" style="background-color: #292E3A;box-shadow: 5px 5px 12px 5px rgba(0,0,0,0.3);margin-top: 15px;padding-bottom: 15px;padding-top: 15px;">
...
@section('script')
    ...
    <script src="{{ asset('js/organizer/dota2-match-detail.js') }}"></script>
@endsection
