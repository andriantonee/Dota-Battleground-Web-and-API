<nav class="navbar navbar-inverse" style="min-width: 1024px;border-radius: 0px;">
    <div class="container-fluid">
        <div class="navbar-header">
            <a class="navbar-brand" style="display: table-cell;vertical-align: middle;height: 50px;padding: 0px;padding-right: 15px;float: none;" href="#">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    <a role="button" class="dropdown-toggle dropdown-toggle-open" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <i class="glyphicon glyphicon-user"></i>&nbsp;&nbsp;Andrianto&nbsp;<span class="caret"></span>
                    </a>
                    <ul class="dropdown-menu">
...
<div class="modal modal-remove-padding-right" id="sign-in-modal" tabindex="-1" role="dialog" aria-labelledby="sign-in-modal-label">
    <div class="modal-dialog modal-dialog-fixed-width" role="document">
                ...
                <form>
                    <div class="form-inline form-inline-authentication">
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="sign-in-email" name="email" placeholder="Email">
                        </div>
                        <div class="form-group">
                ...
                <form>
                    <div class="form-inline form-inline-authentication">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" id="sign-up-confirm-password" name="password_confirmation" placeholder="Confirm Password">
                        </div>
                    </div>
