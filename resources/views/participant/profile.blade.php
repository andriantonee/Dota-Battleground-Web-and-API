                            ...
                            <div class="tab-pane fade in active" id="teams-tab">
                                ...
                                @else
                                    <div style="height: 100px;">
                                        <p style="color: #ba3f3f;line-height: 100px;margin: 0;text-align: center;">You need to upload an Identity Card &amp; wait until admin verified that your Identity Card is valid to Create New Team</p>
                                    </div>
                                @endif
                            </div>
    ...
    <div class="modal modal-remove-padding-right" id="settings-modal" tabindex="-1" role="dialog" aria-labelledby="settings-modal-label">
        <div class="modal-dialog modal-dialog-fixed-width-400" role="document">
            <div class="modal-content modal-content-custom">
                ...
                <div class="modal-body">
                    <p style="color: #ba3f3f;">* Identity Card must be uploaded &amp; verified by admin in order to use all facilities.</p>
                    @if ($pending_identification_file_name)
                        <div class="form-padding-left-right-15">
                            <label style="color: #5F89A3;">Pending Identity Card</label>
                            <div class="thumbnail" style="width: 338px; height: 188px;">
                                <img src="{{ asset('storage/member/identification/'.$pending_identification_file_name) }}" style="width: 328px;height: 178px;">
                            </div>
                        </div>
                    @endif
                    @if ($identification_file_name)
                        <div class="form-padding-left-right-15">
                            ...
                            <div class="thumbnail" style="width: 338px; height: 188px;">
                                <img src="{{ asset('storage/member/identification/'.$identification_file_name) }}" style="width: 328px;height: 178px;">
                            </div>
                        </div>
                    @endif
                    @if ($rejected_identification_file_name)
                        <div class="form-padding-left-right-15">
                            <label style="color: #ba3f3f;">Rejected Identity Card</label>
                            <div class="thumbnail" style="width: 338px; height: 188px;">
                                <img src="{{ asset('storage/member/identification/'.$rejected_identification_file_name) }}" style="width: 328px;height: 178px;">
                            </div>
                        </div>
                    @endif
                    @if (!$pending_identification_file_name)
...
@section('script')
    <script type="text/javascript">
        var has_identifications = {{ $identification_file_name ? "true" : "false" }};
    </script>
